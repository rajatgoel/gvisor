...
func Init() {
	abisOnce.Do(func() {
		...
		v535_104_05 := addUnsupportedDriverABI(535, 104, 05, func() *driverABI {
			...
			return &driverABI{
				...
				controlCmd: map[uint32]controlCmdHandler{
					...
					nvgpu.NV0000_CTRL_CMD_CLIENT_GET_HANDLE_INFO:                           ctrlHandler(rmControlSimple, compUtil),
					...
					nvgpu.NV2080_CTRL_CMD_GPU_DESCRIBE_PARTITIONS:                          ctrlHandler(rmControlSimple, compUtil),
					nvgpu.NV2080_CTRL_CMD_GPU_GET_PARTITIONS:                               ctrlHandler(rmControlSimple, compUtil),
					nvgpu.NV2080_CTRL_CMD_GPU_GET_PARTITION_CAPACITY:                       ctrlHandler(rmControlSimple, compUtil),
					nvgpu.NV2080_CTRL_CMD_GPU_GET_COMPUTE_PROFILES:                         ctrlHandler(rmControlSimple, compUtil),
					nvgpu.NVC637_CTRL_EXEC_PARTITIONS_GET_ACTIVE_IDS:                       ctrlHandler(rmControlSimple, compUtil),
					nvgpu.NVC637_CTRL_CMD_EXEC_PARTITIONS_GET:                              ctrlHandler(rmControlSimple, compUtil),
					nvgpu.NVC638_CTRL_CMD_GET_UUID:                                         ctrlHandler(rmControlSimple, compUtil),
				...
				allocationClass: map[nvgpu.ClassID]allocationClassHandler{
					...
					nvgpu.AMPERE_SMC_PARTITION_REF:      allocHandler(rmAllocSMCRef[nvgpu.NVC637_ALLOCATION_PARAMETERS], compUtil),
					nvgpu.AMPERE_SMC_EXEC_PARTITION_REF: allocHandler(rmAllocSMCRef[nvgpu.NVC638_ALLOCATION_PARAMETERS], compUtil),
				...
				getInfo: func() *DriverABIInfo {
					return &DriverABIInfo{
						...
						ControlInfos: map[uint32]IoctlInfo{
							...
							nvgpu.NV0000_CTRL_CMD_CLIENT_GET_HANDLE_INFO:                           simpleIoctlInfo("NV0000_CTRL_CMD_CLIENT_GET_HANDLE_INFO", "NV0000_CTRL_CLIENT_GET_HANDLE_INFO_PARAMS"),
							...
							nvgpu.NV2080_CTRL_CMD_GPU_DESCRIBE_PARTITIONS:                          simpleIoctlInfo("NV2080_CTRL_CMD_GPU_DESCRIBE_PARTITIONS", "NV2080_CTRL_GPU_DESCRIBE_PARTITIONS_PARAMS"),
							nvgpu.NV2080_CTRL_CMD_GPU_GET_PARTITIONS:                               simpleIoctlInfo("NV2080_CTRL_CMD_GPU_GET_PARTITIONS", "NV2080_CTRL_GPU_GET_PARTITIONS_PARAMS"),
							nvgpu.NV2080_CTRL_CMD_GPU_GET_PARTITION_CAPACITY:                       simpleIoctlInfo("NV2080_CTRL_CMD_GPU_GET_PARTITION_CAPACITY", "NV2080_CTRL_GPU_GET_PARTITION_CAPACITY_PARAMS"),
							nvgpu.NV2080_CTRL_CMD_GPU_GET_COMPUTE_PROFILES:                         simpleIoctlInfo("NV2080_CTRL_CMD_GPU_GET_COMPUTE_PROFILES", "NV2080_CTRL_GPU_GET_COMPUTE_PROFILES_PARAMS"),
							nvgpu.NVC637_CTRL_EXEC_PARTITIONS_GET_ACTIVE_IDS:                       simpleIoctlInfo("NVC637_CTRL_EXEC_PARTITIONS_GET_ACTIVE_IDS", "NVC637_CTRL_EXEC_PARTITIONS_GET_ACTIVE_IDS_PARAMS"),
							nvgpu.NVC637_CTRL_CMD_EXEC_PARTITIONS_GET:                              simpleIoctlInfo("NVC637_CTRL_CMD_EXEC_PARTITIONS_GET", "NVC637_CTRL_EXEC_PARTITIONS_GET_PARAMS"),
							nvgpu.NVC638_CTRL_CMD_GET_UUID:                                         simpleIoctlInfo("NVC638_CTRL_CMD_GET_UUID", "NVC638_CTRL_GET_UUID_PARAMS"),
						...
						AllocationInfos: map[nvgpu.ClassID]IoctlInfo{
							...
							nvgpu.AMPERE_SMC_PARTITION_REF:      ioctlInfo("AMPERE_SMC_PARTITION_REF", nvgpu.NVC637_ALLOCATION_PARAMETERS{}),
							nvgpu.AMPERE_SMC_EXEC_PARTITION_REF: ioctlInfo("AMPERE_SMC_EXEC_PARTITION_REF", nvgpu.NVC638_ALLOCATION_PARAMETERS{}),
		...
		v550_40_07 := addUnsupportedDriverABI(550, 40, 07, func() *driverABI {
			...
			// NVC637_CTRL_CMD_GET_UUID does not exist before 550.
			abi.controlCmd[nvgpu.NVC637_CTRL_CMD_GET_UUID] = ctrlHandler(rmControlSimple, compUtil)
			...
			abi.getInfo = func() *DriverABIInfo {
				info := prevGetInfo()
				info.ControlInfos[nvgpu.NVC637_CTRL_CMD_GET_UUID] = simpleIoctlInfo("NVC637_CTRL_CMD_GET_UUID", "NVC637_CTRL_GET_UUID_PARAMS")
